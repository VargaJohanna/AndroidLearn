...
class SettingsPresenter constructor(private val settingsActivity: SettingsActivity) {
            ...
            FirebaseDatabase.getInstance().reference.child("Users")
                    ...
                    .addValueEventListener(object : ValueEventListener {
                        override fun onDataChange(dataSnapshot: DataSnapshot) {
                            ...
                            settingsActivity.updateUserDetails(userDisplayName, userStatusData, userThumbImage)
                        }
